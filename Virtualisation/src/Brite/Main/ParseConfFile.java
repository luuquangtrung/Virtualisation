...
final public class ParseConfFile {
	...
	public static BriteModel Parse(String confFile) {
	...
	Util.DEBUG("Parser found Top Down BriteModel");
	...
	Util.DEBUG("Parser found Bottom Up BriteModel");
	...
	private static FileModel ParseFileModel(@SuppressWarnings("rawtypes") HashMap params, int modelName) {
    ...
    @SuppressWarnings("rawtypes")
	private static BriteModel ParseWaxman(HashMap params, int modelName) {
    ...
    @SuppressWarnings("rawtypes")
	private static BriteModel ParseBarabasi(HashMap params, int modelName) {
	int N =  (int)  ((Double)params.get("N")).doubleValue();
	int HS =  (int)  ((Double)params.get("HS")).doubleValue();
	int LS =  (int)  ((Double)params.get("LS")).doubleValue();
	int np = (int)  ((Double)params.get("NodePlacement")).doubleValue();
    ...
    @SuppressWarnings("rawtypes")
	private static BriteModel CreateModel(HashMap params) {
	/*first get name*/
