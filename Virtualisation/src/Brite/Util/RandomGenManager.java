...
/**
   ...
   handles all the independent random number generator streams a BriteModel
   may require.  Example, a BriteModel may require a random generator for
   ...
   <p> Each BriteModel has one (and only one) RandomGenManager.  See, for
   instance, BriteModel.setRandomGenManager() method.
  */
