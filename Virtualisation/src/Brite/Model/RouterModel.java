...
/** Derived from class BriteModel, this abstract class serves as a parent
...
this class, but you are free to derive your class directly from BriteModel.

ASModel is an analogous class for Autonomous System (AS) level topologies.

*/
public abstract class RouterModel extends BriteModel {
