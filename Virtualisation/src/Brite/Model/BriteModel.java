...
/** 
    All Topology generation in BRITE is governed by a BriteModel Class.  A
    BriteModel is a member variable of every topology and knows how to
    generate a representative graph.  <br><br> Class BriteModel is the base
...
public abstract class BriteModel { 
    ...
    /** Each model has one random number generator manager.  This
        RandomGenManager is usually created outside the BriteModel and if specific
    ...
    */
    ...
    /**  Set the RandomGenManager for this BriteModel.  Usually this is set
	 by the creator of a BriteModel, once the BriteModel is successfully
	 created.  Each BriteModel requires several independent random
	 ...
	 respective seeds.  Each BriteModel thus has one RandomGenManager,
  ...
  /** Get method used by a BriteModel instance.  Your sub-class may extend this.
      @return int*/
  ...
  public int getConnLocal() { return connLocality; }
    ...
    /** Get the number of nodes in a topology to be generated by a BriteModel instance.
      @return int*/
  public int getN() { return N;}

  /** Get the m parameter used by a BriteModel instance.
      @return int*/
  public int getM() { return m; }
  
  //abstract public BriteModel() { }  No constructor because simple "BriteModel" is meaningless
    
  
  /**
     All Models that are derived from this base BriteModel class, must
