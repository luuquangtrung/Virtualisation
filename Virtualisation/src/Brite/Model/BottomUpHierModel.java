...
public class BottomUpHierModel extends BriteModel {
	...
	public BottomUpHierModel(BriteModel r, int numASNodes, int groupingMethod, int asType, int bwInter, float interMin, float interMax)
    {
	this.r = r;
	...
	String modelParams = "BriteModel ("+ModelConstants.HI_BOTTOMUP+" - BottomUp): ";
